...
from colornet_utils import create_image_with_shapes, _compute_cosine, ColorNet, optim_init_colornet_list
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="models/colorpeel_e4c_multi_vertex",
...
def main(args):
    ...
    train_dataset = CustomDiffusionDataset_ColorList(
        tokenizer=tokenizer,
